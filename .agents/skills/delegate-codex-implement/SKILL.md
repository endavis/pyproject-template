...
description: Delegate implementation of a GitHub issue to Codex CLI. Hands implementation work to Codex via `codex -a never --dangerously-bypass-hook-trust exec` and returns the result to the calling agent.
---
