...
- **[AI Agent Setup](development/AI_SETUP.md)** - Setup guide for AI coding assistants (Claude Code is the primary agent; Copilot, Codex and Antigravity have narrower roles)
